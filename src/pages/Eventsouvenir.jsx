...
const Eventsouvenir = () => {
  ...
  const applyFilter = () => {
    ...
    productsCopy = productsCopy.filter(item => item.category === 'Event & Souvenir Merchandise');
  ...
  useEffect(() => {
    if (products.length > 0) {
      ...
      products.forEach(product => {
        if (product.category === 'Event & Souvenir Merchandise' && product.brand && product.brand.trim() !== '') {
  ...
  if (products.filter(p => p.category === 'Event & Souvenir Merchandise').length === 0) {
    ...
    <div className='flex flex-col sm:flex-row gap-1 sm:gap-10 pt-10 border-t'>
      ...
      <div className='flex-1'>
        <div className='flex justify-between text-base sm:text-2xl mb-4'>
          <Title text1={'EVENT &'} text2={'SOUVENIR MERCHANDISE'} />
