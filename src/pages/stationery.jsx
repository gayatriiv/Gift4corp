...
const stationery = () => {
  ...
  const applyFilter = () => {
    ...
    productsCopy = productsCopy.filter(item => item.category === 'Stationery & Academic Supplies');
  ...
  useEffect(() => {
    if (products.length > 0) {
      ...
      products.forEach(product => {
        if (product.category === 'Stationery & Academic Supplies' && product.brand && product.brand.trim() !== '') {
  ...
  if (products.filter(p => p.category === 'Stationery & Academic Supplies').length === 0) {
    ...
    <div className='flex flex-col sm:flex-row gap-1 sm:gap-10 pt-10 border-t'>
      ...
      <div className='flex-1'>
        <div className='flex justify-between text-base sm:text-2xl mb-4'>
          <Title text1={'STATIONERY &'} text2={'ACADEMIC SUPPLIES'} />
