...
const stationery = () => {
  ...
  useEffect(() => {
    if (products.length > 0) {
      const filtered = products.filter(product => product.category === 'Stationery & Academic Supplies');
    ...
    <div className='border-t pt-10'>
      <div className='text-center py-8 text-3xl'>
        ...
        <p className='w-3/4 m-auto text-xs sm:text-sm md:text-base text-gray-600'>
          Quality stationery and academic supplies for students and professionals.
        </p>
      </div>
