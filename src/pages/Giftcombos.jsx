...
const Giftcombos = () => {
  ...
  const applyFilter = () => {
    ...
    productsCopy = productsCopy.filter(item => item.category === 'Gift Sets & Combos');
  ...
  useEffect(() => {
    if (products.length > 0) {
      ...
      products.forEach(product => {
        if (product.category === 'Gift Sets & Combos' && product.brand && product.brand.trim() !== '') {
  ...
  if (products.filter(p => p.category === 'Gift Sets & Combos').length === 0) {
