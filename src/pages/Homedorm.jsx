...
const Homedorm = () => {
  ...
  useEffect(() => {
    if (products.length > 0) {
      const filtered = products.filter(product => product.category === 'Home & Dorm Essentials');
  ...
  return (
    <div className='border-t pt-10'>
      <div className='text-center py-8 text-3xl'>
        <Title text1={'HOME &'} text2={'DORM ESSENTIALS'} />
        <p className='w-3/4 m-auto text-xs sm:text-sm md:text-base text-gray-600'>
          Essential items to make your home or dorm room comfortable and stylish.
        </p>
      </div>
