...
const Lifestyle = () => {
  ...
  const applyFilter = () => {
    ...
    productsCopy = productsCopy.filter(item => item.category === 'Lifestyle & Utility Items');
  ...
  useEffect(() => {
    if (products.length > 0) {
      ...
      products.forEach(product => {
        if (product.category === 'Lifestyle & Utility Items' && product.brand && product.brand.trim() !== '') {
